...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    "import { FullStackDeveloper } from 'ashish.dev';",
    "",
    "const developer = new FullStackDeveloper({",
    "  name: 'Ashish Bhalsod',",
    "  stack: ['React.js', 'Node.js', 'React Native', 'iOS'],",
    "  focus: 'Building scalable web and mobile applications',",
    "  status: '5+ years experience',",
    "  location: 'Rajkot, Gujarat'",
    "});",
    "",
    "await developer.launchPortfolio();",
    "// Featured: E-commerce, SaaS, Healthcare, FinTech, Food Tech",
    "",
    "developer.connect();",
  ...
  const achievements = [
    ...
    { number: "10+", label: "Mobile Apps", icon: <Zap className="h-3 w-3" /> }
  ];
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-background via-background/95 to-primary/10" ref={ref}>
      ...
      <div className="container mx-auto w-full mt-16 sm:mt-0 px-2 sm:px-6 lg:px-12">
        <motion.div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-8" initial="hidden" animate={isInView ? "visible" : "hidden"} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.25, delayChildren: 0.5 } } }}>
          ...
          <motion.div className="flex-1 flex justify-center lg:justify-end w-full" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
            <div className="relative w-full max-w-md">
              <motion.div className="bg-background/90 border border-border rounded-2xl p-4 sm:p-6 md:p-8 backdrop-blur-sm shadow-2xl w-full group hover:shadow-3xl transition-all duration-500" whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 400, damping: 25 }}>
